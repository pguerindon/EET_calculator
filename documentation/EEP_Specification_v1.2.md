...
This document defines Version 1.2 of the
Electronic Equivalent Time Exchange Protocol (EEP).

This document is the official specification of Version 1.2 of the Electronic Equivalent Time Exchange Protocol (EEP).

Version 1.2 is fully backward compatible with Version 1.0 for all operations defined by Version 1.0.
...
| `competitors`      | array  | Yes      | List of competitors. Initial Requests and Optional Secondary Requests SHALL contain exactly 11 competitors. |
